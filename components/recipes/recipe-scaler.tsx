        ...
        <div className="bg-amber-50 border border-amber-100 rounded-2xl p-5">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:min-w-[420px]">
              <div>
                <p className="text-xs text-slate-500">Yield ใหม่</p>
              ...
              <div>
                <p className="text-xs text-slate-500">จำนวนเสิร์ฟ</p>
                <p className="font-bold text-slate-800 mt-1">
                  {scaledServings !== null
            ...
            <table className="w-full min-w-[560px] text-sm">
              <thead>
                <tr className="text-slate-500 border-b border-slate-100">
                  <th className="text-left px-5 py-3">วัตถุดิบ</th>
                  <th className="text-right px-5 py-3">สูตรต้นฉบับ</th>
                  <th className="text-right px-5 py-3">ปริมาณใหม่</th>
                </tr>
              </thead>
                ...
                {scaledIngredients.map((item) => (
                  <tr key={item.id}>
                    ...
                    <td className="px-5 py-4 text-right font-bold text-amber-600">
                      {formatNumber(item.scaledQuantity)} {item.unit}
                    </td>
                  </tr>
                ))}
              </tbody>
